...
(62, 11, NULL, '2026-08-06 20:12:26', 28030.00, 0.00, 'sebastian', '1232132', NULL, 'pendiente'),
(63, 11, 'obra casa central', '2026-08-08 21:30:17', 4030.00, 0.00, 'sadf', 'asdf', 'dasfadsf', 'convertido'),
(65, 11, 'sdafadsf', '2026-08-08 21:31:14', 4030.00, 0.00, 'dsafdsafadsfdsafdasfdsafsda', 'fadsf', 'adsfasdfadsfdsafasd', 'convertido'),
(66, 11, 'fdsafds', '2026-08-27 19:47:49', 52018.62, 0.00, 'sadfadsfdsa', '4235432', 'asdf', 'convertido');
...
(677, 62, 333, NULL, 1, 4030.00),
(678, 62, 402, NULL, 1, 24000.00),
(679, 63, 333, NULL, 1, 4030.00),
(681, 65, 333, NULL, 1, 4030.00),
(685, 66, 371, NULL, 1, 25000.00),
(686, 66, 402, NULL, 1, 24000.00),
(687, 66, 291, NULL, 1, 1570.72),
(688, 66, 133, NULL, 1, 723.95),
(689, 66, 132, NULL, 1, 723.95);
...
(48, 'Dicroica Led 7W Fría TREFI', 'I-DL7WFR-TR', 'I-DL7WFR-TR', 5, 16, 755.04, 5, 1328.87, 'activo'),
...
(87, 'Interruptor Termomagnetico Unipolar de 10a (1x10a) BRINNA', 'A-IT1X10-BR', 'A-IT1X10-BR', 7, 12, 2265.12, 1, 4289.92, 'activo'),
(88, 'Interruptor Termomagnetico Unipolar de 16a (1x16a) BRINNA', 'A-IT1X16-BR', 'A-IT1X16-BR', 7, 15, 2265.12, 1, 4289.92, 'activo'),
...
(111, 'Bornera de Distribución -Repartidora- Din Bipolar de 7 Polos BRINNA', 'T-BD2X7-BR', 'T-BD2X7-BR', 7, 6, 12750.37, 9, 25245.74, 'activo'),
...
(180, 'Bornera de Distribución -Repartidora- Din Azul 7 Polos BRINNA', 'T-BD1X7AZ-BR', 'T-BD1X7AZ-BR', 7, 4, 3305.11, 9, 6544.12, 'activo'),
...
(184, 'Bornera de Distribución -Repartidora- Din Tetrapolar 12 Polos ELENT', 'T-BD4X12-EL', 'T-BD4X12-EL', 5, 3, 23738.38, 9, 47001.99, 'activo'),
...
(291, 'Cable Tipo Taller 2x1mm2 Negro FONSECA', 'C-TPR2X1N-FO', 'C-TPR2X1N-FO', 10, 21, 839.96, 2, 1570.72, 'activo'),
...
(309, 'Arandela Plana Zincada de 1/4 - Diam 18.3/7.0 mm', 'Y-ARPL1/4-SK', 'Y-ARPL1/4-SK', 12, 202, 20.77, 12, 37.39, 'activo'),
...
(321, 'Lampara led Cuerpo corto 38w E27 Fria MACROLED', 'I-FL38F-MA', 'I-FL38F-MA', 17, 13, 6295.00, 5, 10072.00, 'activo'),
...
(333, 'Adaptador de rosca Edison E40 a E27 BAW', 'Y-ADE4027-BA', 'I-ADE4027-BA', 11, 5, 2000.00, 12, 4030.00, 'activo'),
...
(371, 'Visita, diagnóstico y presupuesto de servicio de mantenimiento y/o modificación de instalación eléctrica.', 'S-VDP', 'S-VDP', 11, 97, 0.00, 13, 25000.00, 'activo'),
...
(402, 'Instalación de Camára Wifi con conexion a tomacorriente 220v y configuración-vinculación a Aplicación de celular.', 'S-IYCCAMWIFI', 'S-IYCCAMWIFI', 11, 99, 0.00, 13, 24000.00, 'activo'),
...
INSERT INTO `productosxcompras` (`id_pxc`, `id_producto`, `cantidad_agregada`, `precio_unitario`, `id_compra`) VALUES
(26, 224, 1, 0.00, 14),
(27, 199, 1, 0.00, 15),
(31, 333, 2, 0.00, 17),
(32, 111, 2, 0.00, 17),
...
(13, 174, 11, 'prueba', '2026-08-27 19:05:48'),
(14, 171, 11, 'prueba2', '2026-08-27 19:05:56'),
(15, 170, 11, 'prueba3', '2026-08-27 19:06:05'),
(16, 169, 11, 'cristian', '2026-08-27 19:06:13'),
(17, 168, 11, 'prueba6', '2026-08-27 19:06:21');
...
(464, 173, 371, 1, 25000.00, 0.00),
(465, 173, 129, 1, 1181.19, 671.13),
(466, 174, 371, 1, 25000.00, 0.00),
(467, 174, 395, 1, 25000.00, 25000.00),
(468, 174, 129, 1, 1181.19, 671.13),
(469, 175, 87, 2, 4289.92, 2265.12),
(470, 175, 88, 2, 4289.92, 2265.12),
(471, 175, 129, 2, 1300.70, 671.13),
(472, 175, 132, 2, 797.20, 411.34),
(473, 175, 131, 6, 1300.70, 671.13),
(474, 176, 371, 1, 25000.00, 0.00),
...
--
ALTER TABLE `presupuestos`
  MODIFY `id_presupuesto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT de la tabla `presupuestos_productos`
--
ALTER TABLE `presupuestos_productos`
  MODIFY `id_presupuesto_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=690;
...
--
ALTER TABLE `ventas_anuladas`
  MODIFY `id_venta_anulada` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
